...
public class PMItems {
    ...
    public static final Item PHANTASMITE_AXE = register("phantasmite_axe", new AxeItem(MateriaToolMaterials.PHANTASMITE, 6, -3.2f, new Item.Settings().rarity(Rarity.EPIC).group(ItemGroup.COMBAT)) {});
    ...
    public static final Item PHANTASMITE_CHESTPLATE = register("phantasmite_chestplate", new PhantasmiteArmorItem(PhantasmiteArmorMaterial.INSTANCE, EquipmentSlot.CHEST, new Item.Settings().rarity(Rarity.EPIC).group(ItemGroup.COMBAT)));
    public static final Item PHANTASMITE_LEGGINGS = register("phantasmite_leggings", new PhantasmiteArmorItem(PhantasmiteArmorMaterial.INSTANCE, EquipmentSlot.LEGS, new Item.Settings().rarity(Rarity.EPIC).group(ItemGroup.COMBAT)));
    public static final Item PHANTASMITE_BOOTS = register("phantasmite_boots", new PhantasmiteArmorItem(PhantasmiteArmorMaterial.INSTANCE, EquipmentSlot.FEET, new Item.Settings().rarity(Rarity.EPIC).group(ItemGroup.COMBAT)));
    ...
    public static final Item SOULBLAZE_AXE = register("soulblaze_axe", new AxeItem(MateriaToolMaterials.SOULBLAZE, 5, -2.9f, new Item.Settings().rarity(Rarity.RARE).group(ItemGroup.COMBAT)) {});
