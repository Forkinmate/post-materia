...
public class PMItems {
    ...
    public static final Item SOULBLAZE_HOE = register("soulblaze_hoe", new HoeItem(MateriaToolMaterials.SOULBLAZE, 2, -2.0f, new Item.Settings().rarity(Rarity.RARE).group(ItemGroup.COMBAT)) {});
